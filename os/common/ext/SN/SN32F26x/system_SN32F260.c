...
void SystemInit (void)
{
	...
	// Setup prescaler so HCLK is always less than 24MHz, this way it save to configure LPCTRL.
	// NOTE: This assumes it save to select >=24MHz mode while HCLK is <24MHz. LPCTRL most likely configures flash wait states, and in that case the asumption holds.
